        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                ...
                <li class="@yield('status-home')">
                    ...
                    <li class="@yield('status-ruangan')">
                        <a href="/ruangan">
                            <i class="material-icons">home</i>
                            <span>Ruangan</span>
                        </a>
                    </li>
                    <li class="@yield('status-dokter')">
                        <a href="/dokter">
                            <i class="material-icons">person</i>
                            <span>Dokter</span>
                        </a>
                    </li>
                    <li class="@yield('status-pasien')">
                        <a href="/pasien">
                    ...
                    <li class="@yield('status-spesialis')">
                        <a href="/spesialis">
                    ...
                    <li class="@yield('status-pembayaran')">
                        <a href="/pembayaran">
                    ...
                    {{-- <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="/dokter/Gigi">Spesialis GIGI</a>
                            </li>
                            <li>
                                <a href="/dokter/THT">Spesialis THT</a>
                            </li>
                            <li>
                                <a href="/dokter/Penyakit Dalam">Spesialis Penyakit Dalam</a>
                            </li>
                            <li>
                                <a href="/dokter/Tulang">Spesialis Tulang</a>
                            </li>
